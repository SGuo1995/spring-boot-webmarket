...
import guo.proj.javao2o.dao.AwardDao;
import guo.proj.javao2o.dto.AwardExecution;
import guo.proj.javao2o.dto.ImageHolder;
import guo.proj.javao2o.entity.Award;
import guo.proj.javao2o.enums.AwardStateEnum;
import guo.proj.javao2o.exceptions.AwardOperationException;
import guo.proj.javao2o.service.AwardService;
    ...
    public AwardExecution addAward(Award award, ImageHolder thumbnail) {
        ...
        if (award != null && award.getShopId() != null) {
            ...
            try {
                ...
                if (effectedNum <= 0) {
                    throw new AwardOperationException("Failed to add rewards");
                }
            } catch (Exception e) {
                throw new AwardOperationException("Failed to add rewards:" + e.toString());
            }
    ...
    public AwardExecution modifyAward(Award award, ImageHolder thumbnail) {
        ...
        if (award != null && award.getAwardId() != null) {
            ...
            try {
                ...
                if (effectedNum <= 0) {
                    throw new AwardOperationException("Failed to update rewards info");
                }
                return new AwardExecution(AwardStateEnum.SUCCESS, award);
            } catch (Exception e) {
                throw new AwardOperationException("Failed to update rewards info:" + e.toString());
            }
        } else {
            return new AwardExecution(AwardStateEnum.EMPTY);
        }
