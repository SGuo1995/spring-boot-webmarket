...
import guo.proj.javao2o.dao.ProductImgDao;
    ...
    private void addProductImgList(Product product, List<ImageHolder> productImgHolderList) {
        ...
        if (productImgList.size() > 0) {
            try {
                ...
                if (effectedNum <= 0) {
                    throw new ProductOperationException("Failed to create product detailed images");
                }
            } catch (Exception e) {
                throw new ProductOperationException("Failed to create product detailed images:" + e.toString());
            }
        }
    }
