...
import guo.proj.javao2o.dto.ShopAuthMapExecution;
import guo.proj.javao2o.dto.UserAccessToken;
import guo.proj.javao2o.dto.WechatInfo;
...
import guo.proj.javao2o.enums.ShopAuthMapStateEnum;
import guo.proj.javao2o.service.PersonInfoService;
import guo.proj.javao2o.service.ShopAuthMapService;
...
import guo.proj.javao2o.util.ShortNetAddressUtil;
        ...
        if (shopAuthMap != null && shopAuthMap.getShopAuthId() != null) {
            try {
                ...
                if (!checkPermission(shopAuthMap.getShopAuthId())) {
                    modelMap.put("success", false);
                    modelMap.put("errMsg", "Unable to do this modification");
                    return modelMap;
                }
            ...
            modelMap.put("success", false);
            modelMap.put("errMsg", "Please enter required information");
        }
        return modelMap;
    }
