$(function() {
    ...
    var pageSize = 10;
    // 获取该用户的奖品领取记录列表的URL
    var listUrl = '/javao2o/frontend/listuserawardmapsbycustomer';
            ...
            if (data.success) {
                ...
                data.userAwardMapList.map(function(item, index) {
                    ...
                    html += '' + '<div class="card" data-user-award-id='
                        ...
                        + '</p>' + '<span>Need points:' + item.point + '</span>'
                        + '</div>' + '</div>';
                });
    ...
    $('.list-div')
        .on(
            ...
            function(e) {
                ...
                window.location.href = '/javao2o/frontend/myawarddetail?userAwardId='
                    + userAwardId;
            });
    // 无极滚动
